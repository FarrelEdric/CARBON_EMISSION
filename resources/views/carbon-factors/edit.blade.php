...
@section('title', 'Edit Faktor Karbon')
@section('page-title', 'Edit Faktor Karbon')
...
<div class="p-4 md:p-6 max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-xl font-bold text-slate-800 dark:text-slate-100">Edit Parameter: {{ $carbonFactor->name }}</h2>
            <p class="text-xs text-slate-500 dark:text-slate-400">Perbarui koefisien konversi emisi atau faktor perhitungan ICAO.</p>
        </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700/80 p-6 shadow-sm">
        <form method="POST" action="{{ route('carbon-factors.update', $carbonFactor) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text"
                           id="name"
                           name="name"
                           value="{{ old('name', $carbonFactor->name) }}"
                           required
                ...
                <div>
                    ...
                    <input type="text"
                           id="factor_key"
                           name="factor_key"
                           value="{{ old('factor_key', $carbonFactor->factor_key) }}"
                           required
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           id="factor_value"
                           name="factor_value"
                           value="{{ old('factor_value', $carbonFactor->factor_value) }}"
                           required
                ...
                <div>
                    ...
                    <input type="text"
                           id="unit"
                           name="unit"
                           value="{{ old('unit', $carbonFactor->unit) }}"
                ...
                <div>
                    ...
                    <input type="text"
                           id="source"
                           name="source"
                           value="{{ old('source', $carbonFactor->source) }}"
                           class="w-full px-3.5 py-2.5 text-sm bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-800 dark:text-slate-100 focus:ring-2 focus:ring-[#0B5A9E] focus:outline-none">
                </div>
                ...
                <div>
                    ...
                    <input type="date"
                           id="effective_date"
                           name="effective_date"
                           value="{{ old('effective_date', $carbonFactor->effective_date ? $carbonFactor->effective_date->format('Y-m-d') : '') }}"
                           class="w-full px-3.5 py-2.5 text-sm bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-800 dark:text-slate-100 focus:ring-2 focus:ring-[#0B5A9E] focus:outline-none">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description"
                              ...
                              class="w-full px-3.5 py-2.5 text-sm bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-800 dark:text-slate-100 focus:ring-2 focus:ring-[#0B5A9E] focus:outline-none">{{ old('description', $carbonFactor->description) }}</textarea>
                </div>
                ...
                <div class="md:col-span-2 flex items-center gap-3 pt-1">
                    ...
                    <input type="checkbox"
                           ...
                           name="is_active"
                           value="1"
                           {{ old('is_active', $carbonFactor->is_active) ? 'checked' : '' }}
